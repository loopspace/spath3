...
(0,0) .. controls +(1,.5) and +(-1,-.5) .. (2,0);
\draw[yshift=-.5cm] (0,0) .. controls +(1,.5) and +(-1,-.5) .. (2,0) .. controls +(1,.5) and +(-1,-.5) .. (4,0);
\calligraphy[
  yshift=-1cm,
  copperplate
] (0,0) .. controls +(1,.5) and +(-1,-.5) .. (2,0) .. controls +(1,.5) and +(-1,-.5) .. (4,0);
\end{tikzpicture}
...
\draw (4,0) arc[start angle=0, end angle=360, radius=1] -- cycle;
\begin{scope}[xshift=6cm]
\draw (0:1) arc(0:360:1) -- cycle;
\end{scope}
