  ...
  \int_compare:nT {\pgfintersectionsolutions > 0}
  {
    ...
    \int_step_inline:nnnn {1} {1} {\pgfintersectionsolutions}
    {
      ...
      \int_compare:nT { ##1 <= \seq_count:N \l__spath_split_intersections_seq }
      {
        ...
        \tl_set:Nn \l__spath_split_join_b_tl {A}
        \tl_if_eq:NNT \l__spath_split_join_a_tl \l__spath_split_join_b_tl
        {
          \bool_set_false:N \l__spath_split_join_bool
        }
      ...
      {
        \tl_set:Nx \l__spath_split_join_a_tl {\seq_item:Nn \l__spath_split_intersections_seq {##1}}
        \tl_set:Nn \l__spath_split_join_b_tl {B}
...
\DeclareDocumentCommand \SpathSelfIntersect {m}
{
  \spath_split_at_self_intersections:nn {#1}{#1}
}
...
\SpathIntersect{a}{b}
\pgfintersectiongetsolutiontimes{1}{\first}{\second}
\SpathSplitAt{a}{\first}{c}{d}

\path[set spath=c] coordinate (a);
\draw (a) circle[radius=5pt];
\SpathShorten{c}{5pt}
\SpathShortenAtStart{d}{5pt}
\draw[line width=1pt,red,set spath=c];
\draw[line width=1pt,blue,set spath=d];
...
\path
[
  split at self intersections={trefoil}{ABA}
]
...
\tikzset{split at intersections={pathA}{pathB}{pathA}{pathB}{ABAB}}
