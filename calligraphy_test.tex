...
\draw[/pgf/calligraphy/pen colour=red,decorate,decoration={calligraphic straight parenthesis,amplitude=1.5mm},thick] (.6,0) -- ++(0,8);
\draw[/pgf/calligraphy/pen colour=red,decorate,decoration={calligraphic curved parenthesis,amplitude=1.5mm},thick] (1,0) -- ++(0,8);
...
\calligraphy[copperplate,light,taper line width=.5\pgflinewidth] (.1,0) .. controls +(130:.15) and +(0,-.15) .. ++(-.15,.5) -- ++(0,7) .. controls +(0,.15) and +(230:.15) .. ++(.15,.5);
