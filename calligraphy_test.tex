...
\begin{tikzpicture}
\pen[define pen=cplate] (0,0);
\processpen[cplate]
\calligraphy[pen name=cplate] (0,0) .. controls +(1,1) and +(-1,-1) .. ++(5,0);
\end{tikzpicture}

\begin{tikzpicture}
\draw[decorate,decoration={calligraphic brace,amplitude=2mm},ultra thick] (0,0) -- (8,0);
\end{tikzpicture}
